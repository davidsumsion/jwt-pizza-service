...
orderRouter.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    if (r.ok) {
      logger.log('info', 'factory', { order, reportSlowPizzaToFactoryUrl: j.reportUrl, jwt: 'true' })
      ...
      logger.log('error', 'factory', { order, reportSlowPizzaToFactoryUrl: j.reportUrl, jwt: 'false' })
